<?php
// Public page: no auth required. We'll gate booking actions only.
session_start();
$currentUri = $_SERVER['REQUEST_URI'] ?? 'Cars.php';
...
<body data-asset-prefix="<?php echo htmlspecialchars($assetPrefix, ENT_QUOTES); ?>">
    ...
    <section class="car-slider-section">
        ...
        <div class="slider-wrapper">
            ...
            <div class="car-image-container">
                <img src="Assets/Images/uploads/car5.png" alt="Lexus LC SERIES" class="car-image1">
            </div>
            ...
            <div class="car-specs-container" id="carSpecs">
                ...
                <div class="car-specs">
                    <div class="spec-item">
                        <img src="Assets/Images/uploads/lexus.png" alt="Brand logo" class="spec-icon" data-spec="logo">
                    ...
                    <div class="spec-item">
                        <img src="Assets/Images/fuel.png" alt="Fuel Efficiency" class="spec-icon">
                        <span class="spec-text" data-spec="efficiency">14.2 km/l</span>
                    </div>
                    <div class="spec-item">
                        <img src="Assets/Images/price.png" alt="Price per Day" class="spec-icon">
    ...
    <script>
        // Gate booking actions: if not logged in, send to auth
        const IS_LOGGED_IN = <?php echo isset($_SESSION['user_id']) ? 'true' : 'false'; ?>;
        function goToAuth(returnTo) {
            const url = 'auth.php?action=signin' + (returnTo ? ('&return=' + encodeURIComponent(returnTo)) : '');
            window.location.href = url;
        }
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.rent-btn, .rent-now-btn').forEach(btn => {
