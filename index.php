...
<body data-asset-prefix="<?php echo htmlspecialchars($assetPrefix, ENT_QUOTES); ?>">
    ...
    <section class="steps-section">
        ...
        <div class="steps-wrapper">
            <div class="step-item">
                ...
                <p class="step-description">Choose from our wide range of available vehicles that suit your needs and
                    budget.</p>
            </div>
    ...
    <section class="car-slider-section">
        ...
        <div class="slider-wrapper">
            ...
            <div class="car-image-container">
                <img src="<?php echo $assetPrefix; ?>Assets/Images/uploads/car5.png" alt="Lexus LC SERIES"
                    class="car-image1">
            </div>
            ...
            <div class="car-specs-container" id="carSpecs">
                ...
                <div class="car-specs">
                    <div class="spec-item">
                        <img src="<?php echo $assetPrefix; ?>Assets/Images/uploads/lexus.png" alt="Brand logo"
                            class="spec-icon" data-spec="logo">
    ...
    <section class="stats-section">
        <div class="stats-heading">
            ...
            <h2 class="main-heading">Find the perfect rental car <br>We compare car rental prices, <span
                    class="highlight">you save!</span></h2>
        </div>
    ...
    <section class="faq-section">
        ...
        <div class="faq-items-wrapper" id="faq">
            <div class="faq-item">
                ...
                <p class="faq-answer">To book a car, simply navigate to our "Rent" section, select your preferred car,
                    choose the dates, and follow the booking steps.</p>
            </div>
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">You will need a valid driver's license, identification (like a passport), and a
                    credit card to complete the rental process.</p>
            </div>
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">Yes, basic insurance is included with all rentals. However, you can upgrade your
                    insurance package for additional coverage.</p>
            </div>
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">Yes, we offer one-way rentals. You can return the car to a different location for
                    an additional fee. Check with our team for available options.</p>
            </div>
        </div>
    </section>
